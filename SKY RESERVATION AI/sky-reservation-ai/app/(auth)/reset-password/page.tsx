          ...
          {pageState === "expired" && (
            ...
            >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full bg-gradient-to-r from-[#00E5FF] to-[#7000FF] hover:from-[#00E5FF]/90 hover:to-[#7000FF]/90 text-black font-semibold py-3.5 rounded-xl transition-all duration-200 shadow-lg shadow-[#00E5FF]/20 mb-4"
              >
                Solicitar nuevo enlace
              </Link>
              <Link
                href="/login"
                className="inline-flex items-center gap-1 text-sm text-[#00E5FF] hover:text-[#00E5FF]/80 transition-colors"
              >
