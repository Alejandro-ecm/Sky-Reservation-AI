      ...
      <table width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08)">
        ...
        <tr>
          <td style="background:linear-gradient(135deg,#3b82f6,#8b5cf6);padding:32px;text-align:center">
            <p style="margin:0;color:rgba(255,255,255,0.8);font-size:13px;letter-spacing:1px;text-transform:uppercase">Reservación Confirmada</p>
            <h1 style="margin:8px 0 0;color:#ffffff;font-size:28px;font-weight:800">✅ ¡Todo listo!</h1>
          </td>
        </tr>
        <!-- Body -->
        <tr>
